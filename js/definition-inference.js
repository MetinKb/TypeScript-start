...
function sum(num1, num2, showResult) {
    if (!showResult)
        throw new Error("we can't show the result right now");
    return num1 + num2;
}
...
const fullName = "Metin Karabulut"; // There is no need for type assignment here. TypeScript already infers type based on first value
// const fullName = "Metin Karabulut" 
// Any type
// You can store "any" kind of value in there
const mixedArray = ["String", 1, null, undefined, true];
